...
class StoreMessagesPage extends StatefulWidget {
  StoreMessagesPage({
    super.key,
    required this.chat,
  });
  ChatModel chat;
  @override
  State<StoreMessagesPage> createState() => _StoreMessagesPageState();
}

class _StoreMessagesPageState extends State<StoreMessagesPage> {
